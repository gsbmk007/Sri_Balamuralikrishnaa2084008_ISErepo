...
public static void main(String[] args) {
    ...
    submitButton.addActionListener(e -> {
        ...
        if (season != null) {
            seasonResultLabel.setText("The season in " + country + " for month " + month + " is: " + season);
        } else {
            seasonResultLabel.setText("Season data not found for the given country and month.");
        }
